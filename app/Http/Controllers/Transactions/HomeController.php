...
class HomeController extends Controller
{
    ...
    */
    ...
    public function billings()
    {
        ...
        return view('pages.financial.billings.index')
            ->with('Page', $Page);
    }
    ...
    */
    ...
    public function technical_operations()
    {
        $Page = (object)[
            ...
            'create_option' => 0,
            'subtitle' => "Operações Técnicas",
        ];
        return view('pages.operations.technical_operations.index')
            ->with('Page', $Page);
    }
	...
	public function comercial_operations()
	{
		...
		return view('pages.operations.commercial_operations.index')
			->with('Page', $Page);
	}
