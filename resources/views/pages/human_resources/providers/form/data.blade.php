...
@else
    <h4 class="card-title"><strong>Dados do Fornecedor</strong></h4>
@endif
...
<div class="card-body">
    ...
    <div class="form-row">
        <div class="custom-controls-stacked">
            ...
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="type" value="1" @if(!isset($Data)) checked="" @elseif($Data->isLegalPerson() == 1)  checked=""  @endif>
