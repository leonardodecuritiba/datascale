...
@section('card')
    ...
    <div class="card">
        <h4 class="card-title"><strong>{{$Data->part_prices->count()}}</strong> Preço de Peças</h4>
        ...
        <div class="card-content">
            <div class="card-body">
                ...
                <table class="table table-striped table-bordered" cellspacing="0" data-provide="datatables">
                    ...
                    <tbody>
                    @foreach($Data->part_prices as $sel)
                        <tr>
                            <td>{{$sel['id']}}</td>
                            <td class="data-name">@if($sel['part_id'] != NULL)<a target="_blank" href="{{route('parts.edit',$sel['part_id'])}}">{{$sel->getPartName()}}</a>@endif</td>
